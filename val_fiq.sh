...
python src/eval_retrieval.py \
    ...
    --meta_prompt \
    --target-pad \
    --val-result-txt /home/jumpserver/yxt/cir/composed_image_retrieval/logs/lr=0.0001_wd={args.wd}_agg={args.aggregate}_model={args.model}_batchsize={args.batch_size}_workers={args.workers}_date=2024-03-14-01-22-29/recall_result_fiq_$cloth_type.txt
