...
def parse_args():
    ...
    parser.add_argument(
        "--f",
        default='im2text',
        help="choose the model type of img2text"
    )
    parser.add_argument(
        "--n-ctx",
        default=3,
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="the number of textual image tokens"
    )
    parser.add_argument(
        "--prompt",
        default='fixed',
    ...
    parser.add_argument(
        ...
        default=1.25,
        type=float,
        help="the ratio of targetPad"
    )
    parser.add_argument(
        "--no-val",
        default=False,
        type=bool,
        help="If val during the training process"
    )
    parser.add_argument(
        "--eval-interval",
        default=1,
        type=int,
        help="the frequency of validation during the training"
    )
    parser.add_argument(
        "--saved-model-path",
        default=None,
        type=str,
        help="the dir name of saved model path"
    )
    parser.add_argument(
        "--val-result-txt",
        default=None,
        type=str,
        help="the recall log txt file"
    )
    parser.add_argument(
        "--date",
        default='20240227',
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="output the best validation visualization result."
    )
    parser.add_argument(
        "--visual-compared",
        default=False,
        action='store_true',
        help="show the compared experimences"
    )
    parser.add_argument(
        "--best-visual-path",
        default=None,
        type=str,
        help="the results of best visualization result, load them to the dataloader, for the compared visualization."
    )
    parser.add_argument(
        "--pseudo-only",
        default=False,
