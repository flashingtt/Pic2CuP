...
from model.model import convert_weights, CLIP, IM2TEXT, PromptLearner
...
def main_worker(gpu, ngpus_per_node, log_queue, args):
    ...
    if "csv" in args.retrieval_data:
        ...
        dataset = FashionIQ(args, cloth=args.retrieval_data, 
                            transforms=preprocess_val, 
                            root=root_project, 
                            mode='caps', 
                            vis_mode=True)
    ...
    if args.prompt == 'fixed':
        ...
        visualize_results(model, img2text, args, prompt, dataloader, prompt_learner)
